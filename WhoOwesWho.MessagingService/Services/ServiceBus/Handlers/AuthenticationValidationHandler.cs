...
{
    public class AuthenticationValidationHandler(IMessageResolverService resolver) : IServiceBusMessageHandler
    {
        public string QueueName => MessagingQueues.AuthenticationValidateRequest;
