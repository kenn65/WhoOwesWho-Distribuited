...
{
    public class UserEventUsersHandler(IMessageResolverService resolver) : IServiceBusMessageHandler
    {
        public string QueueName => EventQueues.UserEventUsersRequest;
