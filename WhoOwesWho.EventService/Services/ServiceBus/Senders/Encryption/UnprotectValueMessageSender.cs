...
namespace WhoOwesWho.EventService.Services.ServiceBus.Senders.Encryption
{
    ...
    public class UnprotectValueMessageSender : EventServiceSenderBase, IUnprotectValueMessageSender
    {
        ...
        {
            _processor = client.CreateProcessor(EncryptionQueues.EventUnprotectResponse);
        ...
        public async Task<string> SendAsync(UnprotectValueRequestModel request)
        {
            var task = await SendRequestAsync<UnprotectValueRequestModel, string>(
                request,
                EncryptionQueues.EventUnprotectRequest,
                EncryptionQueues.EventUnprotectResponse);
