...
{
    public class CurrencyReceiver : BackgroundService
    {
        ...
        public CurrencyReceiver(ServiceBusClient client, IServiceScopeFactory scopeFactory, IEnumerable<IQueueHandlerRegistration> registrations)
        {
            _client = client;
