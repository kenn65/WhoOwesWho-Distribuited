...
namespace WhoOwesWho.CurrencyService.Services.ServiceBus.Receivers
{
    public class EncryptionReceiver : BackgroundService
    {
        ...
        public EncryptionReceiver(ServiceBusClient client, IServiceScopeFactory scopeFactory, IEnumerable<IQueueHandlerRegistration> registrations)
        {
            _client = client;
