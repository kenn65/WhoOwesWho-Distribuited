...
namespace WhoOwesWho.UserService.Services.ServiceBus.Receivers
{
    public class UserReceiver : BackgroundService
    {
        ...
        public UserReceiver(ServiceBusClient client, IServiceScopeFactory scopeFactory, IEnumerable<IQueueHandlerRegistration> registrations)
        {
            _client = client;
