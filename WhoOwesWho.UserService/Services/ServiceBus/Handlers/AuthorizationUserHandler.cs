...
{
    public class AuthorizationUserHandler(IMessageResolverService resolver) : IServiceBusMessageHandler
    {
        public string QueueName => UserQueues.AuthorizationUserRequest;
